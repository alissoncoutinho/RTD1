...
namespace Barragem.Controllers
{
    ...
    public class TorneioController : Controller
    {
        ...
        public ActionResult EditInscritos(int torneioId, int filtroClasse = 0, string Msg = "")
        {
            ...
            ViewBag.PagoNoCartao = db.InscricaoTorneio.Where(i => i.torneioId == torneioId && i.isAtivo == true && (i.statusPagamento == "3" || i.statusPagamento=="4")).Select(i => (int)i.userId).Distinct().Count();
            mensagem(Msg);
